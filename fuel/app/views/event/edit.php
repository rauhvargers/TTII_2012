...
<fieldset>
	...
	<div class="input">
	    <?php echo Form::input('title', 
				Input::post('title', isset($event) ? $event->title : ''),
				array("class"=>"span4")
			    ); ?>
	</div>
    </div>
	...
	<div class="input">
	    <?php echo Form::textarea('description', 
				Input::post('description', isset($event) ? $event->description : ''), 
				array("id" => "description", "rows"=> 4, "class"=>"span4")); ?>
	</div>
    </div>
    <div class="clearfix">
	...
	<div class="input">
	    ...
	    echo Form::select("location", Input::post("location", isset($event) ? $event->location->id : 0), $location_options);
	    ?>
